...
assert.match(serviceWorker, /^const CACHE_NAME = "meet-schwerin-v0\.11\.1-r17";/, "service worker cache must be the latest v0.11.1 revision");
for (const asset of [
  "intelligence-core.js",
  "intelligence-v011.js",
  "intelligence-v011.css",
...
console.log("release-smoke: v0.11.1 wiring, r17 hardened app shell, voluntary-status-aware guidance/command sync and no-op plan revision protection look consistent");
