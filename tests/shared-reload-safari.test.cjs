...
assert.match(serviceWorker, /^const CACHE_NAME = "meet-schwerin-v0\.11\.1-r20";/, "Safari reload guard should ride the current validated PWA shell revision");
...
console.log("shared-reload-safari: delegated reload is single-shot, fallback-safe, failure-recoverable, bfcache-aware and aligned with r20");
