...
assert.match(serviceWorker, /^const CACHE_NAME = "meet-schwerin-v0\.11\.1-r17";/, "Safari reload guard should ride the current validated PWA shell revision");
...
console.log("shared-reload-safari: delegated reload is single-shot, fallback-safe, bfcache-aware and aligned with r17");
