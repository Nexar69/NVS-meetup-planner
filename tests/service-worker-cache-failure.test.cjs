  ...
  const context = {
    ...
    caches: {
      ...
      async keys() {
        ...
        return ["stale-cache", "meet-schwerin-v0.11.1-r14", "meet-schwerin-v0.11.1-r15", "meet-schwerin-v0.11.1-r16", "meet-schwerin-v0.11.1-r17", "meet-schwerin-v0.11.1-r18", "meet-schwerin-v0.11.1-r19"];
      },
      async delete(key) {
...
(async () => {
  ...
  assert.match(source, /^const CACHE_NAME = "meet-schwerin-v0\.11\.1-r19";/, "cache failure suite should exercise the current cache revision");
  ...
  console.log("service-worker-cache-failure: r19 install, online loads and activation survive CacheStorage failures without sacrificing older offline fallback or API privacy");
