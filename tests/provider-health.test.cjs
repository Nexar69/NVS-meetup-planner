...
for (const capability of ["sharedCheckins", "organizerReplan", "capabilityRevocation", "realtimeDisruptions"]) {
...
assert.match(sw, /meet-schwerin-v0\.11\.1-r7/, "provider diagnostics should bump the offline app shell revision");
...
console.log("provider-health: backend drift/privacy/PWA wiring looks consistent");
