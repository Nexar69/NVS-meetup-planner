...
assert.match(sw, /^const CACHE_NAME = "meet-schwerin-v0\.11\.1-r18";/, "provider diagnostics should follow the current offline app shell revision");
...
console.log("provider-health: backend drift, stale-probe isolation, safe text rendering, lifecycle, privacy and PWA r18 wiring look consistent");
