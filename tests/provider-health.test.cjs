...
assert.match(sw, /meet-schwerin-v0\.11\.1-r14/, "provider diagnostics should follow the current offline app shell revision history");
...
console.log("provider-health: backend drift, safe text rendering, lifecycle, privacy and PWA wiring look consistent");
