...
assert.match(release, /shared-checkin-queue-v0111\.js/, "release loader must wire the queue runtime");
assert.match(release, /shared-checkin-queue-v0111\.css/, "release loader must wire queue styles");
